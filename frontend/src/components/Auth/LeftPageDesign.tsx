...
export default function LeftPageDesign() {
  return (
    <div
      className="w-[45%] min-h-screen rounded-r-4xl flex flex-col justify-center items-center p-8 
      bg-linear-to-br from-[#1e0a3c] via-[#4c1d95] to-[#f97316] 
    ...
    >
      ...
      <div className="absolute top-[-10%] left-[-10%] w-full h-full bg-[radial-gradient(circle_at_center,rgba(124,58,237,0.15),transparent_70%)]" />
